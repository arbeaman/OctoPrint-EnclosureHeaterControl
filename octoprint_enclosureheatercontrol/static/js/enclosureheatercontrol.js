$(function() {
    function EnclosureHeaterControlViewModel(parameters) {
        ...
        self.onStartup = function() {
            ...
            OctoPrint.simpleApiGet("enclosureheatercontrol").done(function(data) {
        ...
        self.turnEnclosureHeaterOn = function() {
            OctoPrint.simpleApiCommand("enclosureheatercontrol", "turnEnclosureHeaterOn");
        };

        self.turnEnclosureHeaterOff = function() {
            OctoPrint.simpleApiCommand("enclosureheatercontrol", "turnEnclosureHeaterOff");
        };
    ...
    OCTOPRINT_VIEWMODELS.push({
        ...
        elements: ["#navbar_plugin_enclosureheatercontrol", "#settings_plugin_enclosureheatercontrol"]
    });
});
